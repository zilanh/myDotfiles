...
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("notify-send 'Brightness'"), { locked = true })
hl.bind(mainMod .. " + F6", hl.dsp.exec_cmd("notify-send 'Brightness 6'"), { locked = true })
hl.bind(mainMod .. " + F7", hl.dsp.exec_cmd("~/.config/hypr/scripts/backlight --dec"), { locked = true })
